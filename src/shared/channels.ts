export const IPC_CHANNELS = {
  ...
  wchLinkGet: 'wchlink:get',
  wchLinkProbe: 'wchlink:probe',
  wchLinkFlash: 'wchlink:flash',
  wchLinkCancel: 'wchlink:cancel',
  wchLinkEvent: 'wchlink:event',
  ...
  courseLectureGet: 'course:lecture:get',
  ...
  mcuRecentActivityList: 'mcu:recent-activity:list',
  mcuRecentActivityRecord: 'mcu:recent-activity:record',
  externalUrlOpen: 'app:external-url:open',
