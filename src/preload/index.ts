...
const api: RobotDogApi = {
  ...
  listLessonLearningProgress: (courseId) => ipcRenderer.invoke(IPC_CHANNELS.lessonLearningProgressList, courseId),
  updateLessonLearningProgress: (courseId, lessonId, update) => ipcRenderer.invoke(IPC_CHANNELS.lessonLearningProgressUpdate, courseId, lessonId, update),
  listMcuRecentActivity: () => ipcRenderer.invoke(IPC_CHANNELS.mcuRecentActivityList),
  recordMcuRecentActivity: (activity) => ipcRenderer.invoke(IPC_CHANNELS.mcuRecentActivityRecord, activity),
  openExternalUrl: (url) => ipcRenderer.invoke(IPC_CHANNELS.externalUrlOpen, url),
  listLessonAttempts: (courseId, lessonId) => ipcRenderer.invoke(IPC_CHANNELS.courseLessonAttemptsList, courseId, lessonId),
  createLessonAttempt: (input) => ipcRenderer.invoke(IPC_CHANNELS.courseLessonAttemptCreate, input),
  getCourseProgress: (workspaceId) => ipcRenderer.invoke(IPC_CHANNELS.courseProgressGet, workspaceId),
  updateCourseProgress: (workspaceId, update) => ipcRenderer.invoke(IPC_CHANNELS.courseProgressUpdate, workspaceId, update),
