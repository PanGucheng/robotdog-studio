...
if (lesson.verification !== 'pending-hardware-check' || lesson.status !== 'draft') throw new Error('未完成真机验收前，TI GPIO lesson 必须保持 draft')
...
console.log('TI_MSPM0_COURSE_OK courses=1 lessons=1 lectures=1 status=draft-pending-hardware-check')
